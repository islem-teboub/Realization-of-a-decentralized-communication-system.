...
void Segment::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->horloge);
}
...
void Segment::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->horloge);
}
...
int Segment::getHorloge() const
{
    return this->horloge;
}

void Segment::setHorloge(int horloge)
{
...
int SegmentDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='n' && strcmp(fieldName, "num_seq")==0) return base+0;
    if (fieldName[0]=='h' && strcmp(fieldName, "horloge")==0) return base+1;
...
std::string SegmentDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Segment *pp = (Segment *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getNum_seq());
        case 1: return long2string(pp->getHorloge());
        default: return "";
    }
}
...
bool SegmentDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Segment *pp = (Segment *)object; (void)pp;
    switch (field) {
        case 0: pp->setNum_seq(string2long(value)); return true;
        case 1: pp->setHorloge(string2long(value)); return true;
